...
class Story {
  ...
  getHostName() {
    ...
    // changed from: return "hostname.com";
  }
}
...
class User {
   ...
   * - storyy: a Story unstance to add to favorites
   */
   ...
   * - story: the Story instance to reomove from favorites
   */

  async removeFavorite(story) {
    this.favorites = this.favorites.filter(s => s.storyId !==story.storyId);
    await this._addorOrRemoveFavorite("remove",story);
  }
...
/**Contains classes to manage the data of the app and 
 * the connection to the API. The name models.js is used 
 * to describe a file containing these kinds of classes 
 * that focus on the data and logic about the data. 
